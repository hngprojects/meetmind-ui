    ...
    >
      ...
      <div>
        <div className="flex items-center gap-2 pb-4 border-b border-gray-800 mb-6">
          ...
          <span className="text-gray-400 text-xs sm:text-sm pr-2">
            agent.py
          </span>
        </div>
        ...
        <div className="space-y-6 leading-relaxed text-left">
          ...
          <div>
            ...
            <div>
              ...
              <span className="text-[#72EFDD]">&quot;Alex&quot;</span>,{" "}
              <span className="text-white">tone=</span>
              <span className="text-[#72EFDD]">
                &quot;professional&quot;
              </span>, <span className="text-white">mode=</span>
              <span className="text-[#72EFDD]">&quot;standard&quot;</span>)
            </div>
          </div>
          ...
          <div>
            ...
            <div>
              ...
              <div className="pl-6 text-white">
                platform=
                <span className="text-[#72EFDD]">&quot;zoom&quot;</span>,{" "}
                meeting_link=&quot;meeting_url&quot;,
              </div>
              <div className="pl-6 text-white">persona=persona,</div>
              <div className="pl-6">
          ...
          <div className="pt-2">
            ...
            <div>
              <span className="text-[#4EA8DE]">print</span>(result.scorecard,
              result.summary)
            </div>
          </div>
        </div>

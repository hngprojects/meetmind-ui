...
const baseButtonGroupStyles = [
  ...
  "has-[select[aria-hidden=true]:last-child]:[&>[data-slot=select-trigger]:last-of-type]:rounded-r-4xl",
...
const buttonGroupVariants = cva(baseButtonGroupStyles, {
  variants: {
    orientation: {

...
export function useAgentAudioVisualizerAura(
  ...
  // FIX: Converted speed into an animated value to remove direct setState from useEffect
  ...
  useEffect(() => {
    switch (state) {
      ...
      case "failed":
      case "disconnected":
        animateSpeed(10, DEFAULT_TRANSITION);
      ...
      case "pre-connect-buffering":
        animateSpeed(20, DEFAULT_TRANSITION);
      ...
      case "connecting":
      case "initializing":
        animateSpeed(30, DEFAULT_TRANSITION);
        ...
        return;
      case "speaking":
        animateSpeed(70, DEFAULT_TRANSITION);
        animateScale(0.3, DEFAULT_TRANSITION);
